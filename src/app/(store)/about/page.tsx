    ...
    return (
        <div className="container py-12 lg:py-16 space-y-16">
            ...
            <section className="flex flex-col gap-6 max-w-3xl mx-auto text-center">
                ...
                <h1 className="text-2xl md:text-3xl font-bold tracking-tight text-foreground leading-tight whitespace-pre-line">
                    {settings.about.title}
                </h1>
                <p className="text-foreground font-medium leading-relaxed text-sm md:text-base whitespace-pre-line">
