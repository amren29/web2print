...
function AdminOrdersPage() {
    ...
    const [isSidebarOpen, setIsSidebarOpen] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$admin$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(false); // Default Closed
            ...
            if (saved) {
                try {
                    ...
                    const migrated = parsed.map({
                        "AdminOrdersPage.useEffect.migrated": (o)=>{
                            if ([
                                "New Order",
                                "File Check"
                    ...
                    }["AdminOrdersPage.useEffect.migrated"]);
                    setOrders(migrated);
                } catch (e) {
...
_s(AdminOrdersPage, "dCFpt+MWeBR+ySXpY8TpxAkw3+U=", false, function() {
    return [
...
//# sourceMappingURL=admin_303adb00._.js.map